...
return [
     ...
     */
    'description' => 'Ecommerce example application with only some elementary functionality',
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'You can retrieve a token valid for 30 min by calling the POST /api/login endpoint',
    ],
